...
type CasoRequest struct {
	...
	Casos *CasoItem `protobuf:"bytes,1,opt,name=casos,proto3" json:"casos,omitempty"`
}
...
var file_caso_proto_rawDesc = []byte{
	...
	0x74, 0x12, 0x24, 0x0a, 0x05, 0x63, 0x61, 0x73, 0x6f, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
